...
class Usuario{
    ...
    public function GuardarUsuario(){
        $sql =("INSERT INTO usuarios(cod_usr, nom_usr, pass_usr, rol_usr) 
        VALUES (?,?,?,?)");
    ...
    public function ConsultarUsuario($codUser){
        ...
        $sql="SELECT * FROM usuarios WHERE cod_usr ='$this->codUser' ";
    ...
    public function GetUsuarios(){
		...
		{
			$sql = "SELECT * FROM usuarios WHERE cod_usr ='$codusr' LIMIT 1";
    ...
    public function modificar($codusr, $nomusr,$passusr,$rolusr){
        ...
        $resultado = $this->db->db->query("UPDATE usuarios 
    ...
    public function eliminar($codusr){
        ...
        $resultado = $this->db->db->query("DELETE FROM  usuarios WHERE cod_usr = '$codusr'");
        $this->RedirectAdminUser();
    }
